...
echo ========================================
echo MULAI DOWNLOAD 7-ZIP BRO
echo ========================================

set URL1=https://github.com/ip7z/7zip/releases/download/26.02/7z2602-x64.exe
set FILE1=7z2602-x64.exe
...
echo MsgBox "PC Name: %PCNAME%" ^& vbCrLf ^& "Username: %USERNAME_MSG%" ^& vbCrLf ^& vbCrLf ^& "7-Zip berhasil diinstall bos! Klik OK buat lanjut 😎", vbOKOnly + vbInformation, "TrueAdam Installer V2 - SELESAI" > "%TEMP%\popup.vbs"
